...
cd /Users/ryanhagan/NoCoSMiCC/raw_data/dnase_data/bigWigs
# Transverse colon
wget https://www.encodeproject.org/files/ENCFF405NTZ/@@download/ENCFF405NTZ.bigWig &
wget https://www.encodeproject.org/files/ENCFF753MXL/@@download/ENCFF753MXL.bigWig &
wget https://www.encodeproject.org/files/ENCFF291LZE/@@download/ENCFF291LZE.bigWig &

# Sigmoid colon
wget https://www.encodeproject.org/files/ENCFF299OOV/@@download/ENCFF299OOV.bigWig &

# Left colon
wget https://www.encodeproject.org/files/ENCFF452PQB/@@download/ENCFF452PQB.bigWig &
wget https://www.encodeproject.org/files/ENCFF613BDA/@@download/ENCFF613BDA.bigWig
...
output=/Users/ryanhagan/NoCoSMiCC/ENCODE_outputs/signal_output/Dnase

dataDir=/Users/ryanhagan/NoCoSMiCC/raw_data/dnase_data/bigWigs
