...
# First refomrat the cCRE file to ensure the labels are compatible with downstream steps
...
#!/bin/bash
# bulk only cCREs
cCRE_file=/Users/ryanhagan/NoCoSMiCC/ENCODE_outputs/bulk-only-rCARs/MaxZ/hg38-cCREs-bulk-only.bed
phyloP_signal=/Users/ryanhagan/NoCoSMiCC/Zoonomia/Files/cactus241way.phyloP.bw
output_matrix=/Users/ryanhagan/NoCoSMiCC/Zoonomia/Outputs/bulk_phyloP241_matrix.mtx
